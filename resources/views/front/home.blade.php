        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="false">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('front-assets/images/bg.1.jpg') }}" />
                        <source media="(min-width: 800px)" srcset="{{ asset('front-assets/images/bg.1.jpg') }}" />
                        <img src="{{ asset('front-assets/images/carousel-1.jpg') }}" alt="" />
                    </picture>

                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3">
                            <h1 class="display-4 text-white mb-3">Femme'shion</h1>
                ...
                @if (getCategories()->isNotEmpty())
                    ...
                    <div class="col-lg-3">
                        <div class="cat-card">
                            <div class="left">
                                @if ($categories->image != "")
                                <img src="{{ asset('uploads/category/'.$categories->image) }}" alt="" class="img-fluid">
                                @endif
                            </div>
                            <div class="right">
                                <div class="cat-data">
        ...
        <div class="container">
            ...
            <div class="row pb-3">
                    ...
                    <div class="col-md-3">
                        <div class="card product-card">
                            <div class="product-image position-relative">
                                <!-- <a href="{{ route('front.product',$product->slug) }}">text</a> -->
                                @if (!empty($productImage->image))
                                <a href="{{ route('front.product',$product->slug) }}" class="product-img"><img class="card-img-top" src="{{ asset('uploads/products/'.$productImage->image) }}" alt=""></a>
                                @else
                                <a href="{{ route('front.product',$product->slug) }}" class="product-img"><img class="card-img-top" src="{{ asset('admin-assets/img/default-150x150.png') }}" alt=""></a>
                                @endif
                ...
                <div class="col-md-12 pt-5">
                            {{ $featuredProduct->withQueryString()->links() }}
                </div>          
            </div>
        </div>
    </section>
