...
<section class="content-header">					
				...
				<section class="content">
					...
					<div class="container-fluid">
                        <form action="" method="post" id="updateUserForm" name="updateUserForm">
                        @csrf
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="password" name="password_confirmation" id="password_confirmation"  class="form-control" placeholder="Confirm Password" value="{{ $users->password }}">	
                                            <p></p>
										</div>
									</div>						
									<div class="col-md-6">
