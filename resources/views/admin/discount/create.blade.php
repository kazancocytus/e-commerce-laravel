								...
								<div class="row">
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="code" id="code" class="form-control" placeholder="Coupen code">	
                                            <p></p>
										</div>
									</div>
									<div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="expired_at" id="expired_at" class="form-control" placeholder="Expired at">	
											<p></p>
										</div>
									</div>
								</div>
