					...
					<div class="container-fluid my-2">
						<div class="row mb-2">
							...
							<div class="col-sm-6 text-right">
								<a href="{{ route('create-page') }}" class="btn btn-primary">New Page</a>
							</div>
						</div>
					</div>
					<!-- /.container-fluid -->
                        ...
                        <form action="" method="get">
							<div class="card-header">
                                <div class="card-title">
                                    <button type="button" onclick="window.location.href="'{{ route("page") }}'" class="btn btn-default btn-sm">Reset</button>
                                </div>
